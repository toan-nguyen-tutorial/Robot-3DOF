%% Draw HorizontalCylinder
function drawHorizontalCylinder(handles, theta1, x, y, z, radius, height, colr)
...
% Quay quanh tr?c Z
theta_z = theta1;  
R_z = [cos(theta_z) -sin(theta_z) 0; sin(theta_z) cos(theta_z) 0; 0 0 1];  % Ma tr?n quay quanh tr?c Z
coords_z = R_z * coords;  % Áp d?ng phép quay quanh tr?c Z
